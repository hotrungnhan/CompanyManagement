...
import com.example.companymanagement.model.task.TaskInfoModel
import com.example.companymanagement.model.task.TaskInfoRepository
import com.google.firebase.firestore.FirebaseFirestore
import kotlinx.coroutines.launch

class TaskViewModel: ViewModel() {
    var TaskList: MutableLiveData<MutableList<TaskInfoModel>> = MutableLiveData()
    ...
    fun addTask(task: TaskInfoModel) {
        viewModelScope.launch {
    ...
    fun updateTask(task: TaskInfoModel){
        viewModelScope.launch {
            repo.updateTask(task);
        }
    }
    fun deleteTask(task: TaskInfoModel){
        viewModelScope.launch {
