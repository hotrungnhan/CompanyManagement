...
class TaskManager : Fragment(){
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_tablayout_taskview, container, false)
        val pager = root.findViewById<ViewPager2>(R.id.task_manager_viewpager)
        val tablayout = root.findViewById<TabLayout>(R.id.task_manager_tab_layout)
